...
const UserCard = () => {
    return (
        <div>
            ...
            <div className='flex justify-between min-w-full my-1 py-3 px-12'>
                <div className='bg-base-300 text-white px-6 py-4'>
                    <p className='text-lg font-semibold mb-2'>Unlock exclusive features and benefits!</p>
                </div>
            </div>
        </div>
    );
